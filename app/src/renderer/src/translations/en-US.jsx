export default {
	...
	urlInput: {
		...
		ignoreHttps: "Ignore HTTPS errors for this URL",
		ignoreHttpsWarning: "Only enable this for internal sites with self-signed certificates. It disables certificate validation for the capture session.",
		signIn: "Sign in",
